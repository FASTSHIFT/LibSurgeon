...
def main():
    ...
    output_file = os.path.join(output_dir, sanitize_filename(base_name) + "_decompiled.cpp")
    ...
    with open(output_file, 'w') as f:
        ...
        f.write(" * \n")
        f.write(" * WARNING: This is automatically generated code from reverse engineering.\n")
        f.write(" * It may not compile directly and is intended for educational purposes only.\n")
        f.write(" */\n\n")
        ...
        for class_name, funcs in sorted(class_functions.items()):
            ...
            for func, demangled_name in funcs:
                ...
                if decompiled:
                    ...
                    f.write("// [FAILED] Could not decompile: {}\n\n".format(demangled_name))
                    failed_count += 1
